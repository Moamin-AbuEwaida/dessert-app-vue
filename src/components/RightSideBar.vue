  ...
  <v-navigation-drawer app color="fff" right width="290">
    <v-toolbar color="transparent" flat>
      ...
      <v-badge bordered bottom color="red" dot offset-x="8" offset-y="30">
        <v-avatar size="30" class="ml-n3" title>
          ...
          <v-list-item three-line class="text-center">
            <v-list-item-content>
              <div align="center" justify="center">
                <v-img src="1new.jpg" max-height="280" max-width="200"></v-img>
              </div>
    ...
    <v-row class="mt-5">
      ...
      <v-col cols="12" sm="7">
        <h4 class="mt-1">1X Best Chocolate</h4>
      </v-col>
      <v-col cols="12" sm="2">
        <h6 class="mt-2 grey--text">€15</h6>
      </v-col>
      <v-col cols="12" sm="3">
        <v-card
      ...
      <v-col cols="12" sm="2">
        <h6 class="mt-2 grey--text ml-n4">€12,99</h6>
      </v-col>
    </v-row>
...
.v-card.borderout {
  border: 2px solid #d5f0db !important;
}
</style>
